...
truth_df = truth_cat.get_quantities(
    ...
    native_filters=[
        tract_filter([3634, 3635, 3636, 3827, 3828, 3829, 3830, 4025, 4026, 4027])
    ],
)
...
healpix_filter = GCRQuery(
    (lambda h: np.isin(h, ipix, assume_unique=True), "healpix_pixel")
)


print("Loading object-with-truth-match...\n")

object_truth_cat = GCRCatalogs.load_catalog(
...
merge_df2 = merge_df1.merge(
    cosmo_df, left_on="cosmodc2_id", right_on="galaxy_id", how="left"
)

...
from maps_to_cosmology.datamodule_cosmogrid_dc2 import CosmoGridDC2MapsModule
...
@hydra.main(
    version_base=None, config_path="configs", config_name="train_flowmatching_cosmogrid_dc2"
)
def main(cfg: DictConfig) -> None:
    ...
    datamodule = CosmoGridDC2MapsModule(
        ...
        train_dc2_per_cosmogrid=cfg.convergence_maps.train_dc2_per_cosmogrid,
        ...
        seed=cfg.convergence_maps.get("split_seed", cfg.seed),
        augment=cfg.convergence_maps.get("augment", False),
    )
